Mac OS X Installation & Einrichtung
===================================
...
$ ln -s /pub/Library/Application\ Support/MobileSync/ /Users/bernhard/Library/Application\ Support/MobileSync/
...
=== TimeMachine
Die TimeMachine Backups sollte man regelmäßig nicht nur machen, sondern auch überprüfen.
Hierzu mit gedrückter Alt-Taste "Verify Backups" in der Menüleiste wählen.
